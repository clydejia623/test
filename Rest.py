...
def main(para):
    test = RestAPI()
    #enterprise account
    #account : 53a6909c297a59a42a71cfe59d9464b8
    #token : 9f46b96ceb4e11025d06460945e97da1
    #app id : ade57aeeff72411f9fce25d40a2b185c
    accountSid = "53a6909c297a59a42a71cfe59d9464b8"
    accountToken = "9f46b96ceb4e11025d06460945e97da1"
    appId = "ade57aeeff72411f9fce25d40a2b185c"
    to="13012345678"
    ...
    #mail init
    qqhost = 'smtp.qq.com'
    qqusr = '2799637600@qq.com'
    qqpwd = 'vnfnffqjqpqmdeif'
    tomail = '16408015@qq.com'
    
    sm = smtp_send()
    sm.initmail('smtp',True,qqhost,qqusr,qqpwd)
    if para == 'g':
        #查询主账号
        accinfo = test.getAccountInfo(accountSid,accountToken,isUseJson)
        print accinfo
    elif para == 'c':
        newclient = test.applyClient(accountSid,accountToken,appId,clientType,charge,friendlyName,mobile,isUseJson)
        #print newclient
    #sm.sendmail(qqusr,tomail,'account info',accinfo)
...
#test the ucpaas api call delay time ,in millisecond (use get account command)
def ucpaas_delay():
    btime = time.time()
    main('g')
    etime = time.time()
    val = int((etime-btime)*1000)
    return val
